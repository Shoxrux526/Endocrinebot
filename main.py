...
SUBJECTS = {
    ...
    "public": {"name": "Public Health Sciences", "category": "GENERAL PRINCIPLES"},
    ...
    "hematology": {"name": "Hematology and Oncology", "category": "ORGAN SYSTEMS"},
    "musculoskeletal": {"name": "Musculoskeletal, Skin, and Connective Tissue", "category": "ORGAN SYSTEMS"},
    "neurology": {"name": "Neurology and Special Senses", "category": "ORGAN SYSTEMS"},
